...
/* Return value determines if the screen needs redrawn */
bool button_callback_function(void *user_data)
{
...
void setup()
{
  ...
  GUI_Button *b1 = new GUI_Button(BUTTON_ROUND_STYLE, "Button 1", button_callback_function, &value);
...
void loop()
{
  // Simulate touch event on button.
  // view->navigate(10, 45);
  view->draw();
  delay(1000);
}
