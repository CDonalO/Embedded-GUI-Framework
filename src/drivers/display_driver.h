...
public:
    ...
    virtual uint16_t center_text_vertical(PLATFORM_STRING str, uint16_t container_h, uint16_t container_y) = 0;
    virtual uint16_t center_text_horizontal(PLATFORM_STRING str, uint16_t container_w, uint16_t container_x) = 0;
